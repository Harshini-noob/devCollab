...
function CodeReviewPage() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      {/* Result */}
      {result && (
        <div className="mt-6 bg-[#0d1117] border border-[#1e2535] rounded-2xl overflow-hidden animate-fadein">
          <div className="px-5 py-3 border-b border-[#1e2535] flex items-center justify-between">
          ...
          <div className="p-5">
            <pre className="text-sm text-slate-300 leading-7 whitespace-pre-wrap font-sans">{result}</pre>
          </div>
        </div>
      )}
    </div>
